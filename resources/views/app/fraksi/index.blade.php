                ...
                <div class="row">
                    <div class="col-10">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0">Fraksi</h4>
                        </div>
                    </div>
                    <div class="col-md-2 col-sm-2 col mb-2">
                        <a href="{{ url('fraksi/add') }}" class="btn btn-primary btn-block"><i class="fa fa-plus "></i> Tambah </a>
                                    ...
                                    <div class="">
                                        <div class="">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover  nowrap" id="fraksi">
